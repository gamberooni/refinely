"""Bridge between DSPy's metric protocol and crucible's registered metrics.

DSPy optimizers call a metric as ``metric(gold, prediction, trace)``. Crucible
...
optimizes against the same objective as `crucible evaluate`.
"""
